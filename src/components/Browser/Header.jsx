...
const Header = () => {
    return (
        <header className='bg-[#141414] fixed flex top-0 z-50 w-full items-center justify-between px-4 py-5  lg:px-10 lg:py-6'>
            <div className='flex items-center space-x-2 md:space-x-10'>
                ...
                <div className='sm:flex'>
                    ...
                    <Link to='/latest' className="link-style">Latest</Link>
                    <Link to='/mylist' className="link-style">My List</Link>
                </div>
            </div>
            <div className='flex items-center space-x-4 text-sm'>
                ...
                <img
                    className='w-[40px] cursor-pointer rounder'
